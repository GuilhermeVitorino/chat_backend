...
public class TH_DNS_Envio_Atualizacao_Forcada_2 extends Thread {
	...
	public TH_DNS_Envio_Atualizacao_Forcada_2() throws IOException{
		s_socket = new ServerSocket(8822, 10);
	}
