...
public class TH_DNS_Replica_2 extends Thread {
	...
	public int found = 0;
	public String query;
	public TH_DNS_Replica_2() throws IOException{
		s_socket = new ServerSocket(8823, 10);
	}
	...
	public void execQuery() throws IOException{
		...
		outputMensagem.writeUTF("Base de dados do servidor primário atualizada com sucesso!");
	...
	while(true){
		try {
	        ...
	        query = query.replaceAll("dns", "dns2");
	        query = query.substring(query.indexOf(":")+2);
	        
	        execQuery();
	        
	        outputMensagem.writeUTF("Serividor secundário atualizado com sucesso!");
